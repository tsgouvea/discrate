...
sma = AddState(sma, 'Name', 'PreL',...
    'Timer', 0,...
    'StateChangeConditions', {LeftPortOut,'GraceL','GlobalTimer1_End','rewarded_Lin'},...
    'OutputActions', {'GlobalTimerTrig',1});
sma = AddState(sma, 'Name', 'GraceL',...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer1_End','Wait_Lin'},...
    'OutputActions', {});
...
sma = AddState(sma, 'Name', 'PreR',...
    'Timer', 0,...
    'StateChangeConditions', {RightPortOut,'GraceR','GlobalTimer2_End','rewarded_Rin'},...
    'OutputActions', {'GlobalTimerTrig',2});
sma = AddState(sma, 'Name', 'GraceR',...
    'Timer', 0,...
    'StateChangeConditions', {'GlobalTimer2_End','Wait_Rin'},...
    'OutputActions', {});
